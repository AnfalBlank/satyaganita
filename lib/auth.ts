...
export const auth = betterAuth({
  ...
  trustedOrigins: [
    ...
    "http://localhost:3002",
    "http://localhost:3003",
    "http://192.168.163.204:3000",
    "http://192.168.163.204:3002",
    "http://192.168.163.204:3003",
    process.env.NEXT_PUBLIC_APP_URL || "",
    "https://*.vercel.run",
    "https://satyaganita.id",
    "https://www.satyaganita.id",
  ].filter(Boolean),

  // Account management - redirect after login
  account: {
    accountLinkParent: "/admin",
  },

  // Advanced options
  advanced: {
    // Generate ID with nanoid for better IDs
    generateId: () => nanoid(),
  },
